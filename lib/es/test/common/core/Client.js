...
describe("Client.ts", () => {
    describe("initWithMiddleware", () => {
        ...
        it("Init middleware using a middleware array", () => __awaiter(void 0, void 0, void 0, function* () {
            const provider = (done) => {
        ...
        it("Init middleware using a chained middleware array", () => __awaiter(void 0, void 0, void 0, function* () {
            const provider = (done) => {
                done(null, "dummy_token");
            };
            const authHandler = new AuthenticationHandler(new CustomAuthenticationProvider(provider));
        ...
        it("Should throw error in case the access token is undefined", () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const options = {
                    defaultVersion: "v1.0",
                    debugLogging: true,
                ...
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
                const res = yield client.api("/test").get();
            }
            catch (error) {
        ...
        it("Should throw error in case the access token is empty", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("Init middleware with custom hosts", () => __awaiter(void 0, void 0, void 0, function* () {
