...
describe("BatchRequestContent.ts", () => {
    ...
    describe("getContent", () => {
        it("Should return error for empty requests", () => __awaiter(void 0, void 0, void 0, function* () {
            const batchReq = new BatchRequestContent();
            try {
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        it("Should return json content", () => __awaiter(void 0, void 0, void 0, function* () {
            const req = getCreateFolderRequestCopy();
            const batchReq = new BatchRequestContent([req]);
            const content = yield batchReq.getContent();
