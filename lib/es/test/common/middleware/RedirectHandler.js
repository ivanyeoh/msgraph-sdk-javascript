...
describe("RedirectHandler.ts", () => {
    ...
    describe("executeWithRedirect", () => __awaiter(void 0, void 0, void 0, function* () {
        const context = {
            request: "/me",
            options: {
                method: "GET",
        ...
        it("Should not redirect for the redirect count equal to maxRedirects", () => __awaiter(void 0, void 0, void 0, function* () {
            const maxRedirect = 1;
        ...
        it("Should not redirect for the non redirect response", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("Should not redirect for the redirect response without location header", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions();
            dummyHTTPHandler.setResponses([new Response("", { status: 301 }), new Response("ok", { status: 200 })]);
            yield handler["executeWithRedirect"](context, 0, options);
            assert.equal(context.response.status, 301);
        }));
        it("Should not redirect for shouldRedirect callback returning false", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions(undefined, () => false);
            dummyHTTPHandler.setResponses([new Response("", { status: 301 }), new Response("ok", { status: 200 })]);
            yield handler["executeWithRedirect"](context, 0, options);
            assert.equal(context.response.status, 301);
        }));
        it("Should drop body and change method to get for SEE_OTHER status code", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions();
        ...
        it("Should not drop Authorization header for relative url redirect", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions();
            const cxt = {
                request: "/me",
                options: {
        ...
        it("Should not drop Authorization header for same authority redirect url", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions();
            const cxt = {
        ...
        it("Should return success response after successful redirect", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = new RedirectHandlerOptions();
            const cxt = {
                request: "https://graph.microsoft.com/v1.0/me",
                options: {
    ...
    describe("execute", () => __awaiter(void 0, void 0, void 0, function* () {
        it("Should set the redirect value in options to manual", () => __awaiter(void 0, void 0, void 0, function* () {
            const context = {
                request: "/me",
                options: {
                    method: "GET",
