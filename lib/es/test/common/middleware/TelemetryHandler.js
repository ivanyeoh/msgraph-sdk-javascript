...
describe("TelemetryHandler.ts", () => {
    describe("execute", function () {
        ...
        it("Should not disturb client-request-id in the header", () => __awaiter(this, void 0, void 0, function* () {
            const context = {
        ...
        it("Should create client-request-id if one is not present in the request header", () => __awaiter(this, void 0, void 0, function* () {
            const context = {
        ...
        it("Should set sdk version header without feature flag usage if telemetry options is not present", () => __awaiter(this, void 0, void 0, function* () {
            const context = {
                request: GRAPH_BASE_URL,
                options: {
                    headers: {
        ...
        it("Should set sdk version header with feature flag", () => __awaiter(this, void 0, void 0, function* () {
        ...
        it("Should not set telemetry for non-graph url", () => __awaiter(this, void 0, void 0, function* () {
            const context = {
                request: "test url",
                options: {
                    headers: {
        ...
        it("Should not disturb client-request-id in the header when Request object is passed with Graph URL", () => __awaiter(this, void 0, void 0, function* () {
        ...
        it("Should delete Telemetry in the header when Request object is passed with non Graph URL", () => __awaiter(this, void 0, void 0, function* () {
